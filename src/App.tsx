...
// Importar ReactMarkdown (o la librería que elijas)
import ReactMarkdown from "react-markdown"; // Asegúrate de instalarlo.
// Opcional: para procesar saltos de línea simples
    ...
    <div className="flex flex-col h-screen bg-gray-50 p-4">
      ...
      <header className="pb-4 border-b border-indigo-200 mb-4">
        ...
        <p className="text-sm text-gray-500">
          Gestión eventos, Bienvenido Juan.
        </p>
      </header>
